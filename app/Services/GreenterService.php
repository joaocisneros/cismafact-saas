...
class GreenterService
{
    ...
    /**
     * Devuelve el certificado en formato PEM (cert + llave privada).
     *
     * Flujo: si la empresa subio SU certificado .pfx en Config. SUNAT, se usa
     * ese (producción real). Si no, se cae al certificado de prueba compartido
     * (solo válido para beta/desarrollo). Esto permite que una empresa nueva
     * pruebe en beta sin certificado, y al pasar a producción suba el suyo.
     */
    protected function resolveCertificatePem(): string
    {
        ...
        throw new Exception("La empresa {$this->company->razon_social} no tiene un certificado digital configurado.");
    }
    ...
    protected function initializeSee(): See
    {
        ...
        // Certificado: el de la empresa si subio el suyo, o el compartido de prueba.

...
class StoreCreditNoteRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'detalles' => $this->normalizeDetailsPayload($this->input('detalles', $this->input('items', []))),
            'moneda' => $this->input('moneda', $this->input('tipo_moneda', 'PEN')),
            'tipo_doc_afectado' => $this->input('tipo_doc_afectado', $this->input('doc_afectado_tipo')),
            'num_doc_afectado' => $this->normalizeAffectedDocumentNumber(),
        ]);
    }

...
class StoreBoletaRequest extends FormRequest
{
    ...
    {
        $client = $this->input('client', $this->input('cliente', []));
        if (is_array($client)) {
            $client = [
        ...
        $this->merge([
            ...
            'metodo_envio' => $this->input('metodo_envio', $this->boolean('solo_registro') ? 'resumen_diario' : 'individual'),
            'forma_pago_tipo' => $this->input('forma_pago_tipo', $this->input('forma_pago', 'Contado')),
            'forma_pago_cuotas' => $this->input('forma_pago_cuotas', $this->input('cuotas')),

...
class StoreDispatchGuideRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        $transportista = $this->input('transportista', []);
        $conductor = $this->input('conductor', []);
        $vehiculo = $this->input('vehiculo', []);

        $this->merge([
            'destinatario_id' => $this->input('destinatario_id') ?: $this->findOrCreateDemoClient($destinatario),
            'detalles' => $this->input('detalles', $this->input('items', [])),
            'observaciones' => $this->input('observaciones', $this->input('observacion')),
            'transportista_tipo_doc' => $this->input('transportista_tipo_doc', $transportista['tipo_doc'] ?? null),
            'transportista_num_doc' => $this->input('transportista_num_doc', $transportista['num_doc'] ?? null),
            'transportista_razon_social' => $this->input('transportista_razon_social', $transportista['razon_social'] ?? null),
            'conductor_tipo' => $this->input('conductor_tipo', $conductor['tipo'] ?? null),
            'conductor_tipo_doc' => $this->input('conductor_tipo_doc', $conductor['tipo_doc'] ?? null),
            'conductor_num_doc' => $this->input('conductor_num_doc', $conductor['num_doc'] ?? null),
            'conductor_licencia' => $this->input('conductor_licencia', $conductor['licencia'] ?? null),
            'conductor_nombres' => $this->input('conductor_nombres', $conductor['nombres'] ?? null),
            'conductor_apellidos' => $this->input('conductor_apellidos', $conductor['apellidos'] ?? null),
            'vehiculo_placa' => $this->input('vehiculo_placa', $vehiculo['placa'] ?? null),
        ]);
    }

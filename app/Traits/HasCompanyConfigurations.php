...
trait HasCompanyConfigurations
{
    ...
    {
        // GRE solo tiene ambiente de PRODUCCION en SUNAT (no hay beta). Por eso
        // se usa un unico juego de credenciales: se toma el que este configurado
        // (sin importar en que columna quedo guardado).
        return $this->gre_client_id_beta ?: $this->gre_client_id_produccion;
    }

    /**
     * Obtener Client Secret para GRE (juego unico, ver getGreClientId)
     */
    public function getGreClientSecret(): ?string
    {
        return $this->gre_client_secret_beta ?: $this->gre_client_secret_produccion;
    }

            ...
            <x-ficha-credencial ancho="w-full">
                ...
                <x-slot:metricas>
                    ...
                    <x-metrica-credencial titulo="Último uso" tono="blue">
                        <x-slot:icono><svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8"><path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg></x-slot:icono>
                        <span x-text="detalle?.ultimo_uso ?? 'Nunca'"></span>
                    </x-metrica-credencial>
                    <x-metrica-credencial titulo="Creada" tono="green">
                        <x-slot:icono><svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8"><path stroke-linecap="round" stroke-linejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg></x-slot:icono>
                        <span x-text="detalle?.creada"></span>
                    </x-metrica-credencial>
                    <x-metrica-credencial titulo="Caduca" tono="amber" :destacado="true">
                        <x-slot:icono><svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8"><path stroke-linecap="round" stroke-linejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg></x-slot:icono>

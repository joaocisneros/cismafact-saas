...
<body class="bg-gray-50 font-sans antialiased"
    ...
    @php
        ...
        $superAdminItems = [
            ...
            ['label' => 'Tokens de prueba', 'route' => 'super-admin.tokens-prueba.index', 'active' => 'super-admin.tokens-prueba.*', 'color' => 'text-purple-600', 'icon' => 'M15 7a4 4 0 10-3.46 6H9v2H7v2H5v2H3v-4.54L9.54 8A4 4 0 0015 7zm0 0h.01'],            ['label' => 'Soporte', 'route' => 'super-admin.support', 'active' => 'super-admin.support*', 'color' => 'text-rose-600', 'icon' => 'M21 15a4 4 0 01-4 4H8l-5 3V7a4 4 0 014-4h10a4 4 0 014 4v8z'],
            ...
            ['label' => 'Consumo interno', 'route' => 'super-admin.consumo-interno', 'active' => 'super-admin.consumo-interno*', 'color' => 'text-orange-600', 'icon' => 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z'],
